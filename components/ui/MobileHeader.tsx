...
export default function MobileHeader({ isOwner = false }: Props) {
  ...
  return (
    <header className="md:hidden flex items-center justify-between px-4 py-3 bg-white dark:bg-slate-900 border-b border-gray-100 dark:border-slate-700 flex-shrink-0">
      <span className="text-lg font-bold text-gray-900 dark:text-slate-100">Drivn</span>
