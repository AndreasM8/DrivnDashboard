        ...
        <div className="bg-white rounded-xl border border-gray-100">
          {members.length === 0 ? (
            <div className="text-center py-12">
              ...
              <p className="text-sm text-gray-500 mb-4">Invite setters or closers to collaborate.</p>
            ...
            <div>
              {members.map((member, i) => (
                <div key={member.id} className={`flex items-center gap-4 p-4 ${i < members.length - 1 ? 'border-b border-gray-50' : ''}`}>
                  ...
                  <div className="flex gap-2 flex-shrink-0">
                    ...
                    {member.status === 'active' && (
                      <button
                        ...
                        className="text-xs px-3 py-1.5 border border-gray-200 text-gray-600 rounded-lg hover:border-red-200 hover:text-red-600 transition-colors"
                      >
                        Deactivate
                      </button>
                    )}
