...
bot.on('message', async (msg) => {
  ...
  try {
    ...
    const response = await client.messages.create({
      ...
      max_tokens: 2048,
      system: `You are a coding assistant for DrivnDashboardr — a Next.js 16 CRM for online fitness coaches.
Tech: Next.js 16 App Router, TypeScript, Supabase, Tailwind CSS v4, Vercel.
Project root: ${PROJECT_ROOT}

Current git status:\n${gitStatus}
Recent commits:\n${gitLog}

Be concise and actionable. When making code changes, show the exact edits needed.`,
